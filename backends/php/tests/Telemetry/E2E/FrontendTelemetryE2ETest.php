...
namespace App\Tests\Telemetry\E2E;
...
class FrontendTelemetryE2ETest extends WebTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        // Читаем credentials из env-переменных (передаются через docker-compose run -e)
        self::$clickhouseUser = (string) (getenv('CLICKHOUSE_USER') ?: 'telemetry_user');
        self::$clickhousePass = (string) (getenv('CLICKHOUSE_PASSWORD') ?: '');
    ...
    public function happyPathEventAppearsInClickHouse(): void
    {
        ...
        // Ищем спан по session.id — этот атрибут разрешён в UIProfile и устанавливается
